...
namespace Graphics
{
    public partial class table2 : Form
    {
            ...
            if (Page <= 3 && Page > 0)
            {
                ...
                if (this.CAT == 10)
                {
                    ...
                    else if (Page == 3)
                    {
                        ...
                        labelSystemStatus.Visible = true;
                        labelFleetID.Visible = false;
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (asterixFile.getListCatAll()[rowindex].CATMode == "SMR" || asterixFile.getListCatAll()[rowindex].CATMode == "MLAT")
            {
                this.CAT = 10;
            }
            else
            ...
            if (Mode == 0)
            {
                ...
                {
                    this.CAT = 21;
                    if (asterixFile.getListCat21()[indexValor].flightLevel != null) { labelFL.Text = "FL " + Convert.ToString(asterixFile.getListCat21()[indexValor].flightLevel.flightLevel); } else { labelFL.Text = ""; }
                    if (asterixFile.getListCat21()[indexValor].positionWGS84 != null) { labelPosWGS84.Text = Convert.ToString(asterixFile.getListCat21()[indexValor].positionWGS84.latitude) + "º, " + Convert.ToString(asterixFile.getListCat21()[indexValor].positionWGS84.longitude) + "º"; } else { labelPosWGS84.Text = ""; }
                    if (asterixFile.getListCat21()[indexValor].trueAirspeed != null) { label16.Text = "Airspeed: " + Convert.ToString(asterixFile.getListCat21()[indexValor].trueAirspeed.trueAirspeed); } else { label16.Text = "Airspeed: "; }
                    if (asterixFile.getListCat21()[indexValor].targetStatus != null) { label22.Text = "Surveillance Status: " + asterixFile.getListCat21()[indexValor].targetStatus.surveillanceStatus + "\n" + "Priority Status: " + asterixFile.getListCat21()[indexValor].targetStatus.priorityStatus; } else { label22.Text = "Surveillance Status: "; }
                    if (asterixFile.getListCat21()[indexValor].timeOfApplicabilityPosition != null) { label23.Text = "Time Of Applicability Position: " + Convert.ToString(asterixFile.getListCat21()[indexValor].timeOfApplicabilityPosition.toaSeconds) + " s"; } else { label23.Text = "Time Of Applicability Position: "; }
                    if (asterixFile.getListCat21()[indexValor].timeOfMessageReceptionPosition != null) { label24.Text = "Time Of Message Reception Position: " + Convert.ToString(asterixFile.getListCat21()[indexValor].timeOfMessageReceptionPosition.tomSeconds) + " s"; } else { label24.Text = "Time Of Message Reception Position: "; }
                    if (asterixFile.getListCat21()[indexValor].trackAngleRate != null) { label25.Text = "Track Angle Rate: " + Convert.ToString(asterixFile.getListCat21()[indexValor].trackAngleRate.trackAngleRate) + " º/s"; } else { label25.Text = "Track Angle Rate: "; }
                    if (asterixFile.getListCat21()[indexValor].timeOfApplicabilityVelocity != null) { label26.Text = "Time Of Applicability Velocity: " + Convert.ToString(asterixFile.getListCat21()[indexValor].timeOfApplicabilityVelocity.toaSeconds) + " s"; } else { label23.Text = "Time Of Applicability Velocity: "; }
                    if (asterixFile.getListCat21()[indexValor].timeOfMessageReceptionVelocity != null) { label27.Text = "Time Of Message Reception Velocity: " + Convert.ToString(asterixFile.getListCat21()[indexValor].timeOfMessageReceptionVelocity.tomSeconds) + " s"; } else { label24.Text = "Time Of Message Reception Velocity: "; }
                    if (asterixFile.getListCat21()[indexValor].geometricHeight != null) { label28.Text = "Geometric Height: " + asterixFile.getListCat21()[indexValor].geometricHeight.geometricHeight + "m"; } else { label28.Text = "Geometric Height: "; }
                    if (asterixFile.getListCat21()[indexValor].qualityIndicators != null) { label29.Text = "Quality indicatos: " + QualityIndicatorsDec(asterixFile, indexValor); } else { label29.Text = "Quality indicatos: "; }
                    if (asterixFile.getListCat21()[indexValor].mOPSVersion != null) { label30.Text = "MOPS Version: " + MOPSDEC(asterixFile, indexValor); } else { label30.Text = "MOPS Version: "; }
                    if (asterixFile.getListCat21()[indexValor].mode3ACode != null) { label31.Text = "Mode 3A Code: " + asterixFile.getListCat21()[indexValor].mode3ACode.replyCode; } else { label30.Text = "Mode 3A Code: "; }
                    if (asterixFile.getListCat21()[indexValor].rollAngle != null) { label32.Text = "Roll Angle: " + asterixFile.getListCat21()[indexValor].rollAngle.rollAngle; } else { label32.Text = "Roll Angle: "; }
                    if (asterixFile.getListCat21()[indexValor].magneticHeading != null) { label33.Text = "Magnetic Heading: " + asterixFile.getListCat21()[indexValor].magneticHeading.magneticHeading; } else { label33.Text = "Magnetic Heading: "; }
                    if (asterixFile.getListCat21()[indexValor].barometricVerticalRate != null) { label34.Text = "Barometric Vertical Rate: " + asterixFile.getListCat21()[indexValor].barometricVerticalRate.barometricVerticalRateFtPerMin; } else { label34.Text = "Barometric Vertical Rate: "; }
                    if (asterixFile.getListCat21()[indexValor].geometricVerticalRate != null) { label35.Text = "Geometric Vertical Rate: " + asterixFile.getListCat21()[indexValor].geometricVerticalRate.geometricVerticalRateFtPerMin; } else { label35.Text = "Geometric Vertical Rate: "; }
                    if (asterixFile.getListCat21()[indexValor].airborneGroundVector != null) { label36.Text = "Airborne Ground Vector: " + GroundVector(asterixFile, indexValor); } else { label36.Text = "Airborne Ground Vector: "; }
                    if (asterixFile.getListCat21()[indexValor].emitterCategory != null) { label37.Text = "Emitter Category: " + asterixFile.getListCat21()[indexValor].emitterCategory.emitterCategory; } else { label37.Text = "Emitter Category: "; }
                    if (asterixFile.getListCat21()[indexValor].metInformation != null) { label38.Text = "Met Information: " + METinfoDEC(asterixFile, indexValor); } else { label38.Text = "Met Information: "; }
                    if (asterixFile.getListCat21()[indexValor].selectedAltitude != null) { label39.Text = "Selected Altitude: " + asterixFile.getListCat21()[indexValor].selectedAltitude.altitude; } else{label39.Text = "Selected Altitude: "; }
                    if (asterixFile.getListCat21()[indexValor].trajectoryIntent != null) { label40.Text = "Trajectory Intent: " + TrajectoryDEC(asterixFile, indexValor); } else { label40.Text = "Trajectory Intent: "; }
                    if (asterixFile.getListCat21()[indexValor].serviceManagement != null) { label41.Text = "Service Management: " + asterixFile.getListCat21()[indexValor].serviceManagement.reportPeriod; } else { label41.Text = "Service Management: "; }
                    if (asterixFile.getListCat21()[indexValor].aircraftOperationalStatus != null) { label42.Text = "Aircraft Operational Status: " + OperationalStatusDEC(asterixFile, indexValor); } else { label42.Text = "Aircraft Operational Status: "; }
                    if (asterixFile.getListCat21()[indexValor].surfaceCapabilitiesAndCharacteristics != null) { label43.Text = "Surface Capabilities And Characteristics: " + SurfaceDEC(asterixFile, indexValor); } else { label43.Text = "Surface Capabilities And Characteristics: "; }
                    if (asterixFile.getListCat21()[indexValor].messageAmplitude != null) { label44.Text = "Message Amplitude: " + asterixFile.getListCat21()[indexValor].messageAmplitude.messageAmplitudedBm; } else { label44.Text = "Message Amplitude: "; }
                    if (asterixFile.getListCat21()[indexValor].modeSMBData != null) { label45.Text = "Mode S MB Data: " + asterixFile.getListCat21()[indexValor].modeSMBData.bdsList; } else { label45.Text = "Mode S MB Data: "; }
                    if (asterixFile.getListCat21()[indexValor].aCASResolutionAdvisoryReport != null) { label47.Text = "ACAS Resolution Advisory Report: " + ACASResolDEC(asterixFile, indexValor); } else { label47.Text = "ACAS Resolution Advisory Report: "; }
                    if (asterixFile.getListCat21()[indexValor].receiverId != null) { label48.Text = "Receiver ID: " + asterixFile.getListCat21()[indexValor].receiverId.receiverId; } else { label48.Text = "Receiver ID: "; }
                    if (asterixFile.getListCat21()[indexValor].dataAges != null) { dataAgeRowInt = indexValor; label49.Text = "Data Ages: double click to see info"; } else { dataAgeRowInt = -1; label49.Text = "Data Ages: "; }
                    if (asterixFile.getListCat21()[indexValor].targetReportDescriptor != null) { label50.Text = "Target Report Description: " + TargetDevolver(asterixFile, indexValor); } else { label50.Text = "Target Report Description: "; }
                    if (asterixFile.getListCat21()[indexValor].serviceIdentification != null) { label51.Text = "Service Identification: " + asterixFile.getListCat21()[indexValor].serviceIdentification.serviceIdentification; } else { label51.Text = "Service Identification: "; }
                }
            }
            else if (Mode == 1)
            {
